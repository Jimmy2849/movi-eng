...
def threeChatStory():
    ...
    if token:
        ...
        main_character = file_path + 'oz5.png'
        llm_character = file_path + 'oz3.png'
        goal1_image_path = file_path + "oz6.png"
        goal2_image_path = file_path + "oz7.png"
