...
client = OpenAI(api_key="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")
main_character = '/Users/ihoyeol/Desktop/moving/image/oz5.png'
llm_character = '/Users/ihoyeol/Desktop/moving/image/oz3.png'
goal1_image_path = "/Users/ihoyeol/Desktop/moving/image/oz6.png"
goal2_image_path = "/Users/ihoyeol/Desktop/moving/image/oz7.png"
...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://i.imgur.com/UxhXLMo.png[/img]");
...
with st.sidebar:
    ...
    st.divider()
    st.markdown("목표 1. : 양철 나무꾼을 만나세요.")
    st.markdown("목표 2. : 겁쟁이 사자를 만나세요.")
    st.divider()
...
for message in st.session_state.messages:
    with st.chat_message(message["role"], avatar=message.get("avatar", None)):
        if message["content"] == situation:
            ...
            st.image('/Users/ihoyeol/Desktop/moving/image/oz4.png')
        else:
