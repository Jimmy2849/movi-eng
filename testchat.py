...
main_character = 'image/image5.jpeg'
llm_character = 'image/image1.jpeg'
...
def chatting():
    user_input_audio = None  # 사용자 입력을 여기서 초기화합니다.
